...
('reto-arreglo-nombres', 'Ordenar nombres alfabéticamente', 'js', 'facil',
 ...
 'try { var original = ["Carlos", "Ana", "Beto"]; var r = ordenarNombres(original); return Array.isArray(r) && r[0] === "Ana" && r[1] === "Beto" && r[2] === "Carlos" && original[0] === "Carlos"; } catch(e) { return false; }',
 25, 16),
...
('reto-objeto-persona', 'Crear un objeto y acceder a sus datos', 'js', 'facil',
 ...
 'try { var p = crearPersona("Ana", 25); return p && p.nombre === "Ana" && p.edad === 25; } catch(e) { return false; }',
 15, 17),
...
('reto-filtrar-productos', 'Filtrar productos por precio', 'js', 'medio',
 ...
 'try { var r = productosCaros([{nombre:"A",precio:10},{nombre:"B",precio:50}], 20); return Array.isArray(r) && r.length === 1 && r[0].nombre === "B"; } catch(e) { return false; }',
 25, 19),
...
('reto-clase-rectangulo', 'Clase Rectángulo', 'js', 'dificil',
 ...
 '', '',
 'class Rectangulo {\n  // completa la clase\n}',
 'try { var r = new Rectangulo(4, 5); return r.area() === 20; } catch(e) { return false; }',
 30, 20);
